      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          ...
          >
            ...
            <div 
              id="terminal-content"
              className="p-1.5 max-[359px]:p-1.5 min-[360px]:p-2 min-[414px]:p-2.5 sm:p-3 md:p-6 bg-black text-green-400 font-mono w-full max-w-full overflow-auto h-[70vh] md:overflow-auto md:h-72 lg:h-80"
            >
              {/* Prompt */}
